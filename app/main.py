...
import tensorflow as tf  # Tensorflow 2.4.1
import numpy as np
import pandas as pd
...
model_1_path = './saved_models/binary/model_binary'
model1 = tf.keras.models.load_model(model_1_path)

model_2_path = './saved_models/stars/model_stars'
...
async def predict_qwery(start: int=0, limit: int=3):
    ...
    comment = pd.read_csv(r'./comentarios.txt', header=None, delimiter='\n')
